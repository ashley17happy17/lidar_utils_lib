...
void executeDownsample(pcl::PointCloud<pcl::PointXYZI>::Ptr &cloud,
                       float voxelSize, std::vector<double>* timestamps = nullptr);

void executeRemoveArtifact(pcl::PointCloud<pcl::PointXYZI>::Ptr &cloud, std::vector<double>* timestamps = nullptr);

void executeRemoveNaN(pcl::PointCloud<pcl::PointXYZI>::Ptr &cloud, std::vector<double>* timestamps = nullptr);
